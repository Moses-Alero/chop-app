...
- Name: app.spec.ts >> Choplink Telegram Mini App flows >> history screen clearly states current mode limitation
...
Locator: getByText(/Order history is unavailable in current app mode/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Order history is unavailable in current app mode/)
